...
FROM employees
WHERE department_id IN (2, 5, 7) AND DATE(hire_date) > '200-01-01'
...
AS SELECT department_id, manager_id, salary
FROM employees
...
SELECT `id`, `first_name`, `deposit_amount` FROM wizzard_deposits;
